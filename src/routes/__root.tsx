...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Copo da Felicidade, Bombom no Pote e mais delícias artesanais. Peça pelo cardápio online da TonTon Doces." },
      { property: "og:title", content: "TonTon Doces — Doceria Artesanal" },
      { property: "og:description", content: "Copo da Felicidade, Bombom no Pote e mais delícias artesanais. Peça pelo cardápio online da TonTon Doces." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TonTon Doces — Doceria Artesanal" },
      { name: "twitter:description", content: "Copo da Felicidade, Bombom no Pote e mais delícias artesanais. Peça pelo cardápio online da TonTon Doces." },
